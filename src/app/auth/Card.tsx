  ...
  return (
    <div className="absolute h-96 w-96  ">
      <div className="max-w-lg mx-auto p-6 bg-gradient-to-b from-gray-900 to-black rounded-xl shadow-lg border border-gray-700 ">
        <h1 className="text-4xl font-bold text-white mb-2">Leetcode Wrapped</h1>
      ...
      <div className="text-center my-10 bg-gradient-to-r from-blue-500 to-purple-600 text-white p-2 rounded-md">
